...
class HomePageDocument extends StatelessWidget {
  const HomePageDocument({super.key});
        ...
        children: [
                          ...
                          builder: (context, controller, child) =>
                            ...
                            itemBuilder: (context, index) => ContainerWD(
                              ...
                              colors: controller.selectedindex == index
                                  ...
                                  : Colors.black,
                              child: ListTile(
                                leading: documenticone[index],
                                title: AppText(document[index]),
                            ...
                            itemCount: documentscreen.length,
                          ),
                        ),
                      ],
                    ),
          ...
          Expanded(
            child: Consumer<Controller>(
              builder: (context, controller, child) =>
                  documentscreen[controller.selectedindex],
            ),
          ),
        ],
      ),
