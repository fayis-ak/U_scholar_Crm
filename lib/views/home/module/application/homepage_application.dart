...
class HomePageApplication extends StatelessWidget {
  const HomePageApplication({super.key});
        ...
        children: [
                          ...
                          builder: (context, controller, child) =>
                            ...
                            itemBuilder: (context, index) => ContainerWD(
                              ...
                              colors: controller.selectedindex == index
                                  ...
                                  : Colors.black,
                              child: ListTile(
                                leading: applicationicone[index],
                                title: AppText(Application[index]),
                            ...
                            itemCount: applicationscreen.length,
                          ),
                        ),
                      ],
                    ),
          ...
          Expanded(
            child: Consumer<Controller>(
              builder: (context, controller, child) =>
                  applicationscreen[controller.selectedindex],
            ),
          ),
        ],
      ),
