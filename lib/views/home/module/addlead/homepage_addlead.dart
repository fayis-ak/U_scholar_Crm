...
class HomePageAddLead extends StatelessWidget {
  const HomePageAddLead({super.key});
        ...
        children: [
                          ...
                          builder: (context, controller, child) =>
                            ...
                            itemBuilder: (context, index) => ContainerWD(
                              ...
                              colors: controller.selectedindex == index
                                  ...
                                  : Colors.black,
                              child: ListTile(
                                leading: addleadicone[index],
                                title: AppText(addlead[index]),
                            ...
                            itemCount: addleadscreen.length,
                          ),
                        ),
                      ],
                    ),
          ...
          Expanded(
            child: Consumer<Controller>(
              builder: (context, controller, child) =>
                  addleadscreen[controller.selectedindex],
            ),
          ),
        ],
      ),
